<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="NumericSequenceCalculator_Web_Interface.Account.OpenAuthProviders" %>
